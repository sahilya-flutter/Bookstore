...
class HanumanChlisaBook extends StatefulWidget {
  const HanumanChlisaBook({Key? key}) : super(key: key);

  @override
  State<HanumanChlisaBook> createState() => _HanumanChlisaBookState();
}

class _HanumanChlisaBookState extends State<HanumanChlisaBook> {
  String? localPath;
  bool isLoading = true;
  ...
  Future<void> _loadPdfAndExtractText() async {
    try {
      ...
      // Load PDF file
      final bytes = await rootBundle.load('assets/pdf/Tulsi-hunuman-chalisa.pdf');
      final dir = await getTemporaryDirectory();

      final file = File('${dir.path}/Tulsi-hunuman-chalisa.pdf');
