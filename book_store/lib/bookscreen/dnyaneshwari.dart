...
class DnyaneshwariBook extends StatefulWidget {
  const DnyaneshwariBook({super.key});

  @override
  State<DnyaneshwariBook> createState() => _DnyaneshwariBookState();
}

class _DnyaneshwariBookState extends State<DnyaneshwariBook> {
  String? localPath;
  bool isLoading = true;
